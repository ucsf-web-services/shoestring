/*
 ...
 MyFonts Webfont Build ID 2934074, 2014-12-04T19:17:11-0500
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2934074

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2cc53a";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"HelveticaNeueLTStd-Lt",url:wfpath+"2CC53A_0"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-MdIt",url:wfpath+"2CC53A_1"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-Bd",url:wfpath+"2CC53A_2"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-Roman",url:wfpath+"2CC53A_3"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-Md",url:wfpath+"2CC53A_4"+suffix+"_0."+webfontType},{fontFamily:"GranjonLTStd",url:wfpath+"2CC53A_5"+suffix+"_0."+
webfontType},{fontFamily:"GranjonLTStd-Italic",url:wfpath+"2CC53A_6"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-It",url:wfpath+"2CC53A_7"+suffix+"_0."+webfontType},{fontFamily:"HelveticaNeueLTStd-LtIt",url:wfpath+"2CC53A_8"+suffix+"_0."+webfontType},{fontFamily:"GranjonLTStd-Bold",url:wfpath+"2CC53A_9"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+
